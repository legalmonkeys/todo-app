...
ALTER TABLE todo_item ADD COLUMN position INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE todo_item ADD CONSTRAINT uk_todo_item_list_position UNIQUE (list_id, position);
